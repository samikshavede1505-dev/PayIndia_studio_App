...
const popularBoards = [
    { id: '1', name: "Municipal Corporation", icon: "city-variant-outline" },
    { id: '2', name: "Delhi Jal Board", icon: "water-pump" },
    { id: '3', name: "Water Supply Dept", icon: "water-outline" },
    { id: '4', name: "Rural Water Authority", icon: "home-city-outline" },
    { id: '5', name: "BWSSB", icon: "water-check-outline" },
    { id: '6', name: "HMWSSB", icon: "water-sync" },
];

const allBoards = [
    "Municipal Corporation", "Delhi Jal Board", "Water Supply Dept", "Rural Water Authority",
    "BWSSB - Bangalore", "HMWSSB - Hyderabad", "MCGM - Mumbai", "KWA - Kerala",
    "UP Jal Nigam", "PHED - Rajasthan", "GWSSB - Gujarat", "TWAD - Tamil Nadu",
    "Burdwan Municipality", "Chandigarh Water Dept", "Pune Municipal Corp",
    "Surat Municipal Corp", "Lucknow Jal Sansthan", "Jaipur PHED", "Indore Municipal Corp"
];

export default function WaterBillPaymentScreen() {
    ...
    const [billDetails, setBillDetails] = useState<WaterBillDetails | null>(null);
    ...
    const handleFetchBill = async () => {
        ...
        setIsLoading(true);
        setTimeout(() => {
            const mockData: WaterBillDetails = {
            ...
            <SafeAreaView style={styles.safeArea}>
                ...
                <View style={styles.header}>
                    ...
                    <View style={styles.headerCenter}>
                        ...
                        <Text style={styles.headerSubtitle}>Pay your water bill securely</Text>
                    </View>
                            ...
                            {!billDetails ? (
                                <>
                                    ...
                                    <View style={styles.browseContainer}>
                                        <TouchableOpacity style={styles.browseButton} onPress={() => setShowBoardModal(true)}>
                                            <Text style={styles.browseText}>View All Water Boards</Text>
                                    ...
                                    <View style={styles.formCard}>
                                        {selectedBoard ? (
                                            <View style={styles.fieldGroup}>
                                                <Text style={styles.fieldLabel}>Selected Water Board</Text>
                                                <View style={[styles.inputContainer, styles.readOnlyInput]}>
                                                    <MaterialCommunityIcons name="water-pump" size={16} color="#94A3B8" />
                                                    <TextInput
                                        ...
                                        <View style={styles.fieldGroup}>
                                            <Text style={styles.fieldLabel}>Consumer Number / Connection ID *</Text>
                                        ...
                                        <View style={styles.fieldGroup}>
                                            <Text style={styles.fieldLabel}>Area / Ward (if required)</Text>
                                            <View style={styles.inputContainer}>
                                ...
                                <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
                                    ...
                                    <View style={styles.summaryCard}>
                                        <View style={styles.summaryHeader}>
                                            <Ionicons name="water" size={24} color="#0D47A1" />
                                        ...
                                        <View style={styles.summaryRow}>
                                            <Text style={styles.summaryLabel}>Connection ID</Text>
                                        ...
                                        <View style={styles.summaryRow}>
                                            ...
                                            <Text style={styles.summaryValue}>{billDetails.waterUsage}</Text>
                                        </View>
                                        <View style={styles.summaryRow}>
                                            <Text style={styles.summaryLabel}>Due Date</Text>
                                            <Text style={[styles.summaryValue, { color: '#D32F2F' }]}>{billDetails.dueDate}</Text>
                                        </View>

                                        <View style={styles.amountBanner}>
                                            <View>
                                                <Text style={styles.bannerLabel}>Bill Amt</Text>
                                                <Text style={styles.bannerValue}>₹{billDetails.outstandingAmount}</Text>
                                            </View>
                                            <View style={styles.verticalDivider} />
                                            <View>
                                                <Text style={styles.bannerLabel}>Late Fee</Text>
                                                <Text style={styles.bannerValue}>₹{billDetails.lateFee}</Text>
                                            </View>
                                        </View>
                                    </View>
                                    ...
                                    <TouchableOpacity style={styles.declarationRow} onPress={() => setIsConfirmed(!isConfirmed)}>
                                        ...
                                        <Text style={styles.declarationText}>I confirm that the above details are correct and authorize this water bill payment.</Text>
                                    </TouchableOpacity>
                    ...
                    <View style={styles.modalOverlay}>
                        <View style={styles.modalContent}>
                            <View style={styles.modalHeader}>
                                ...
                                <TouchableOpacity onPress={() => setShowBoardModal(false)}><Ionicons name="close" size={24} color="#666" /></TouchableOpacity>
                            </View>
                            <View style={styles.modalSearch}>
                                <Ionicons name="search" size={20} color="#666" />
                                <TextInput style={styles.modalSearchInput} placeholder="Search Water Board..." value={boardSearchQuery} onChangeText={setBoardSearchQuery} />
                            </View>
                    ...
                    <View style={styles.successOverlay}>
                        <View style={styles.successCard}>
                            ...
                            <View style={styles.receipt}>
                                <View style={styles.receiptRow}><Text style={styles.receiptLabel}>Transaction ID</Text><Text style={styles.receiptValue}>TX-WAT-{Math.floor(Math.random() * 900000) + 100000}</Text></View>
                                <View style={styles.receiptRow}><Text style={styles.receiptLabel}>Consumer No.</Text><Text style={styles.receiptValue}>{consumerNumber}</Text></View>
